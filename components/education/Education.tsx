    ...
    return (
        <div className={"px-10 py-5 mx-5 my-5 shadow-[inset_0_10px_15px] rounded-3xl flex flex-row items-center-safe"}>
            <div className={"flex flex-col w-3/4"}>
                ...
                <School logo={"/tcu_icon.png"} level={"Undergraduate"} name={"Texas Christian University"} gpa={3.975} start={new Date(2021, 7)} end={new Date(2025, 4)} degree={"Bachelor of Science"} firstmajor={"Computer Science"} secondmajor={"Mathematics"} place={"Fort Worth, Texas"} courses={courses}/>
            </div>
